package com.vchohan.golftravel.weather.adapters;
...
import com.vchohan.golftravel.weather.models.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        customViewHolder.itemPressure
            .setText(context.getString(R.string.pressure) + ": " + new DecimalFormat("#.0").format(pressure) + " " +
