package com.vchohan.golftravel.weather.activities;
...
import com.vchohan.golftravel.weather.AlarmReceiver;
import com.vchohan.golftravel.weather.Constants;
import com.vchohan.golftravel.weather.adapters.ViewPagerAdapter;
import com.vchohan.golftravel.weather.adapters.WeatherRecyclerAdapter;
import com.vchohan.golftravel.weather.fragments.RecyclerViewFragment;
import com.vchohan.golftravel.weather.models.Weather;
import com.vchohan.golftravel.weather.tasks.GenericRequestTask;
import com.vchohan.golftravel.weather.tasks.ParseResult;
import com.vchohan.golftravel.weather.tasks.TaskOutput;
import com.vchohan.golftravel.weather.utils.UnitConvertor;
import com.vchohan.golftravel.weather.widgets.AbstractWidgetProvider;
import com.vchohan.golftravel.weather.widgets.DashClockWeatherExtension;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            String state = reader.getString("name");
            String country = "";
    ...
    void getCityByLocation() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            progressDialog
                .setButton(DialogInterface.BUTTON_NEGATIVE, getString(R.string.dialog_cancel), new DialogInterface.OnClickListener() {
                    @Override
