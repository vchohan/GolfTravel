package com.vchohan.golftravel.weather;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public class GetWeatherTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                String apiKey = sp.getString("apiKey", context.getResources().getString(R.string.google_api_key));
                URL
                    url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + URLEncoder
                    .encode(sp.getString("city", Constants.DEFAULT_CITY), "UTF-8") + "&lang=" + language + "&appid=" + apiKey);
    ...
    class GetLongTermWeatherTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                String apiKey = sp.getString("apiKey", context.getResources().getString(R.string.google_api_key));
                URL
                    url = new URL("http://api.openweathermap.org/data/2.5/forecast?q=" + URLEncoder
                    .encode(sp.getString("city", Constants.DEFAULT_CITY), "UTF-8") + "&lang=" + language + "&mode=json&appid=" + apiKey);
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                BufferedReader r = new BufferedReader(new InputStreamReader(urlConnection.getInputStream()));
    ...
    public class GetLocationAndWeatherTask extends AsyncTask<String, String, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (location != null) {
                Log.d(TAG,
                    String.format("Determined location: latitude %f - longitude %f", location.getLatitude(), location.getLongitude()));
    ...
    public class GetCityNameTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String apiKey = sp.getString("apiKey", context.getResources().getString(R.string.google_maps_key));

            try {
                URL
                    url =
                    new URL(
                        "http://api.openweathermap.org/data/2.5/weather?q=&lat=" + lat + "&lon=" + lon + "&lang=" + language + "&appid=" +
                            apiKey);
